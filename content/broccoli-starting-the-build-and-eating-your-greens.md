...
Having made these original decisions, we ultimately decided to build something called [broccoli-static-site-json](https://github.com/empress/broccoli-static-site-json) which as you can see has very similar goals to broccoli-blog-api:
...
I hope you enjoyed this deep-dive into the guts of broccoli-static-site-json. If you are interested in other places that make use of this system you can check out [empress-blog](https://github.com/empress/empress-blog) which also happens to be what is powering this Blog 🎉

As always you can reach out to me on [Twitter](https://twitter.com/real_ate), or you can find me on the Ember Community Discord as `@real_ate` or just simply `Chris Manson`
